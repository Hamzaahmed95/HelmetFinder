...
public class GetMyHelmet extends FragmentActivity implements OnMapReadyCallback ,TaskLoadedCallback,
        GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,LocationListener{

    private GoogleMap mMap;
    private GoogleApiClient mGoogleApiClient;
    public static final String TAG = GetMyHelmet.class.getSimpleName();
...
*/
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       /* //
        ...
        new FetchURL(GetMyHelmet.this).execute(url,"driving");
        mMap.addMarker(place1);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if(ContextCompat.checkSelfPermission(this,android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
            ...
            ActivityCompat.requestPermissions(GetMyHelmet.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1600);
